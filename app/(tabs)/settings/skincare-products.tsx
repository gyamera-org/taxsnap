...
import { useSkincareProducts, UserBeautyProduct } from '@/lib/hooks/use-beauty-products';

export default function SkincareProductsScreen() {
  ...
  // Fetch saved skincare products
  const { data: savedProducts = [], isLoading, refetch } = useSkincareProducts();
  ...
  return (
    <>
      <SubPageLayout
        ...
        rightElement={
          <TouchableOpacity
            onPress={() => router.push('/(tabs)/settings/add-skincare-product')}
            className="w-10 h-10 items-center justify-center bg-pink-100 rounded-full"
          >
          ...
          <View className="bg-white p-4 border-b border-gray-200">
            <View className="flex-row items-center justify-between">
              <TouchableOpacity onPress={() => setShowDetailModal(false)}>
                <Text className="text-pink-500 text-lg">Close</Text>
              </TouchableOpacity>
            ...
            <ScrollView className="flex-1 px-4 py-6">
              ...
              <View className="bg-white rounded-2xl p-6 border border-gray-200 mb-4">
                ...
                <View className="gap-3">
                  ...
                  <View className="bg-pink-50 px-4 py-3 rounded-xl">
                    <Text className="text-sm text-gray-600 mb-1">AI Recommends</Text>
                    <Text className="text-base font-medium text-pink-700 capitalize">
