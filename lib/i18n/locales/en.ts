export default {
  ...
  paywall: {
    ...
    subtitle: 'Get unlimited scans and personalized PCOS dietary guidance',
    features: {
      unlimitedScans: {
    ...
    trial: {
      ...
      subtitle: 'Try free, cancel anytime',
      then: 'Then {{price}}/year after trial',
    },
    cta: {
  ...
  settings: {
    ...
    share: {
      ...
      banner: {
        ...
        earnPerReferral: 'Earn $5 per referral',
      },
      modal: {
        title: 'Share & Earn Rewards',
        subtitle: 'Help others manage PCOS and earn rewards!',
        howItWorks: 'How it works:',
        step1: 'Share your unique link with friends',
        step2: 'When they sign up, you both get 1 week free premium',
        step3: 'No limit! Share with as many friends as you like',
        reward: '🎁 Each referral = 1 week free premium for both of you!',
        shareNow: 'Share Now',
        maybeLater: 'Maybe Later',
      },
    },
  ...
  referral: {
    ...
    shareMessage: 'Join me on PCOS Food Scanner! Use my referral code {{code}} to get $5 off. {{link}}',
    hero: {
      title: 'Earn Rewards',
      subtitle: 'Share your referral code with friends and earn $5 per referral!',
    },
    yourCode: 'Your Referral Code',
    shareButton: 'Share with Friends',
    howToEarn: 'How to earn',
    steps: {
      step1: 'Share your promo code to your friends',
      step2: 'Earn $5 per friend that signs up with your code',
    },
    terms: 'Rewards are credited once your friend completes their first subscription payment.',
  },
